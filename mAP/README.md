...
###### For Betty
for main.py
 -put predicted with 1) python3 yolov2_predict_map.py -img XmlToTxt/water_bottle_img -list XmlToTxt/images_list.txt and 2)python convert_pred_yolo.py after copying all the predictions result from XmlToTxt to map/predicted because this code is changing directly the files
 -put ground-truth with
 -change in main.py the img folder
